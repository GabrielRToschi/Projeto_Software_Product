...
class TestJogos(unittest.TestCase):
    ...
    def test_adicionar_jogo(self):
        ...
        resposta_login = self.app.post('/usuarios/login', json={"nome_usuario": "admin", "senha": "1234"})
        ...
        self.assertEqual(resposta.status_code, 201)  # Verifica se o jogo foi criado com sucesso
